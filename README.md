...
An amber **CHECK DRAFT** notice highlights committed-looking picks without a confirmed reading, conflicting saved/manual entries, and missing expected bans. Before picks begin, empty slots are normal. Once picks exist, at least four bans should be recorded; after either team has four picks or the match is starting, six should be recorded. This is a conservative standard-draft check, not recognition of every draft phase. The reader never guesses which missing hero was banned. A paused/unavailable reader warns that saved entries may be stale. Correct highlighted dropdowns or allow another reading before relying on advice.
